...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/.0.26.2@css-loader/index.js!./fontello.css", function() {
				var newContent = require("!!../../node_modules/.0.26.2@css-loader/index.js!./fontello.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
		...
		var Carousel = function () {
			...
			var Carousel = function Carousel($carousel) {
				...
				this.$ct.find('img').height(imgHeight);
